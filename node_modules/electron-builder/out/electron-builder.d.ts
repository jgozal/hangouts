...
declare module "electron-builder/out/platformPackager" {
  import { Arch, FileAssociation, Platform, Target, TargetSpecificOptions } from "electron-builder-core"
  import { AppInfo } from "electron-builder/out/appInfo"
...
declare module "electron-builder" {
  ...
  export { Metadata, Config, AfterPackContext, PlatformSpecificBuildOptions } from "electron-builder/out/metadata"
